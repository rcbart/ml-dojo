...
and up it is more work by hand, but the <i>meaning</i> is identical, a volume-scaling factor.</div>`,
 ...
 quiz:{title:'Quick check',questions:[
   {q:'The determinant of [[3, 1], [2, 4]] is:',
    options:['12, the product of the two entries on the main diagonal','14, the two diagonal products added together','10, the main diagonal product minus the anti-diagonal one','5, the sum of the two entries on the main diagonal'],answer:2,whyWrong:['12 is just the main diagonal product. You still have to subtract the other one.','14 adds the anti-diagonal instead of subtracting it.','','5 is the sum of the diagonal minus something, and it is not the determinant formula.'],
