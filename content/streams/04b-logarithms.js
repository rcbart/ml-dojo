...
one rule true.</div>`,
 ...
 quiz:{title:'Quick check',questions:[
   {q:'2² · 2³ equals:',
    options:['2⁶ = 64, multiplying the exponents together','2⁻¹, subtracting the exponents rather than adding','2⁵ = 32, since multiplying powers adds the exponents','4⁵, multiplying both the bases and the exponents'],answer:2,whyWrong:['That adds the exponents to 6 by mistake. Two plus three is five.','A negative exponent comes from division, not multiplication.','','The base stays 2. It is the exponents that add, not the bases that multiply.'],
    why:'xᵃ·xᵇ = xᵃ⁺ᵇ, so 2²·2³ = 2⁵ = 32. This add-when-you-multiply rule is exactly what logs mirror.'},
   {q:'A negative exponent, like 2⁻¹, means:',
    options:['A negative number','An error','Subtraction','The reciprocal: 1/2¹ = 0.5'],answer:3,whyWrong:['2 to the power minus one is 0.5, which is positive. The sign is on the exponent.','It is perfectly well defined for any nonzero base.','Subtraction of exponents is what division does. A negative exponent is the result, not the operation.',''],
    why:'x⁻ⁿ = 1/xⁿ. Negative exponents flip to the denominator; they are not negative numbers.'},
   {q:'x^(1/2) is another way of writing:',
    options:['the square root of x','x times 0.5','2ˣ','x divided by 2'],answer:0,whyWrong:['','Multiplying by 0.5 is the same as dividing by 2, and it is again not a root.','That puts x in the exponent, which is a completely different function.','Dividing by 2 is x/2, which is not a root.'],
