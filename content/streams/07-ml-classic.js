...
`,
 ...
 quiz:{title:'Quick check, small data',questions:[
   {q:'Small datasets are dominated by which error term?',
    options:['Irreducible noise, since fewer rows means noisier measurements','All three contribute about equally','Variance, since the fit swings with the sample','Bias, since simpler models must be used'],answer:2,whyWrong:['Irreducible noise is fixed by the problem and does not grow as the sample shrinks.','They do not. Variance is the term a small sample inflates.','','Simpler models are the response to the problem, not the source of it.'],
   ...
   {q:'With 200 rows and 20 positives, reporting accuracy is misleading because:',
    options:['Cross-validation cannot be used at all','Cross-validation folds will not contain enough positives to score','Accuracy is undefined for imbalanced data','Predicting the majority class already scores 90%'],answer:3,whyWrong:['Cross-validation works fine. It is the metric that is wrong, not the protocol.','Stratified folds keep the positives distributed. That is a separate concern, and a solvable one.','Accuracy is perfectly well defined here. It is just uninformative.',''],
